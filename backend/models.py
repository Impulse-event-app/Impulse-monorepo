...
class User(Base):
    ...
    home_suburb = Column(String, nullable=True)
    preferred_acts = Column(ARRAY(String), nullable=False, server_default="{}")
...
class Deal(Base):
    ...
    date = Column(String, nullable=False)                      # e.g. "Monday 3 June 2026"
    slots = Column(JSON, nullable=False)                       # ["5:00 PM", "6:00 PM"]
...
class Booking(Base):
    ...
    confirmation_code = Column(String, nullable=False, unique=True)
